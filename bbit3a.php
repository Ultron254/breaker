...
$unordered = "'66.249.72.240'.Chirchir,Olesaningo Mosiro.0760387482.KENYA.+254_'192.168.170.25'.Wambua,Doe Mumbua.080023450.KENYA.+254
...
$i = 'a';
  ...
  $fresh_word2 = explode(".", $fresh_word);
  $fresh_word3= explode(",", $fresh_word2[1]);

echo "($i)"."<a href='bbit.php?ipnumber={$result[0]} '>".$fresh_word3[1]."</a>"." ".$fresh_word3[0]."(# ".$fresh_word2[4]." (0) ".$fresh_word2[2]."[".$fresh_word2[3]."])<br><br>";
